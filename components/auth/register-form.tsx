      ...
      <div className="w-full max-w-md bg-white border-4 border-black p-8 shadow-[12px_12px_0px_#000] relative">
        ...
        <form action={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input id="name" name="name" placeholder="E.G. TOMEK" required maxLength={255} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="email">Email Address</Label>
            <Input id="email" name="email" type="email" placeholder="ADMIN@PROTOSPARK.APP" required maxLength={255} />
          </div>
          <div className="space-y-2">
